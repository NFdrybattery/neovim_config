...
if vim.g.neovide then
  ...
  vim.g.neovide_gpu_accelerated = true --启用GPU加速
  ...
  vim.g.neovide_scroll_animation_far_lines = 3 -- 远距离滚动行数
...
opt.synmaxcol = 200       -- 限制语法高亮列数
opt.encoding = "utf-8"
opt.fileencoding = "utf-8"
opt.fileencodings = { "utf-8", "gbk", "gb2312", "cp936" }
